...
import post from "../../../../public/img/post.jpg";
...
function Signin() {
  ...
  return (
    <section>
      <Image src={post} className="w-full h-sreen object-cover relative flex" />
      <section className=" absolute top-1/2 ml-[50%] translate-x-[-50%] flex flex-col">
        ...
        <Link href={"/"} className="text-center text-black-300 underline">
          Quay lại
        </Link>
      </section>
      <ToastContainer />
