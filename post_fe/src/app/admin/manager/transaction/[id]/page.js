...
function TransactionView({ params }) {
  ...
  async function send(id) {
    ...
    const data = await sendNoteToGathering(
      params.id,
      transaction.idGathering,
      newNote
    );
    ...
    <section className="w-full">
      ...
      <div className="p-5 flex space-x-20 items-center">
        <h2 className="text-xl">
          Thông tin người quản lý khu :{transaction?.name}
        </h2>
        <h2 className="text-xl">
                  ...
                  <Tr keys={i}>
                    ...
                    <Th>
                      <div className="relative">
                        <Button onClick={openModal} className="bg-green-600">
                          Gửi tập kết
                        </Button>
                            ...
                            >
                              ...
                              <section className="w-[500px] p-4">
                                ...
                                <div>
                                  ...
                                  <select
                                    name="typeNote"
                                    onChange={(e) => setValueNote(e.target)}
                                  >
