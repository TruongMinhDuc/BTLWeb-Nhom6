export const Gathering = async (valueForm) => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_APP_URL}/gathering/new`,
    {
      method: "POST",
      headers: {
...
export const AllGathering = async () => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_APP_URL}/gathering/all`,
    {}
  ).then((res) => res.json());
  return res;
};
...
export const GetOneGathering = async (id) => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_APP_URL}/gathering/get/${id}`
  ).then((res) => res.json());
  return res;
};
export const update = async (id, valueForm) => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_APP_URL}/gathering/update/${id}`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const addNote = async (id, valueForm) => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_APP_URL}/gathering/add-note/${id}`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const removeNote = async (id, idGathering) => {
  const res = await fetch(
    `${process.env.NEXT_PUBLIC_API_APP_URL}/gathering/delete-note/${id}/${idGathering}`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
